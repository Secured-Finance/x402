...
describe("withPaymentInterceptor()", () => {
  ...
  beforeEach(async () => {
    ...
    const { selectPaymentRequirements } = await import("@secured-finance/sf-x402/client");
  ...
  it("should handle 402 errors and retry with payment header", async () => {
    ...
    const { createPaymentHeader, selectPaymentRequirements } = await import(
      "@secured-finance/sf-x402/client"
    );
  ...
  it("should reject if payment header creation fails", async () => {
    ...
    const { createPaymentHeader } = await import("@secured-finance/sf-x402/client");
